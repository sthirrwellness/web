...
import img from "../../public/images/Rectangle 141.png";
...
export default function ContactForm() {
  ...
  return (
    <div className="bg-white py-20 px-4 md:px-10 lg:px-20" id='contact'>
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-[40%_auto] gap-10 mt-20">
        {/* Form */}
        <form
        ...
        >
          <input
            ...
            className="w-full border border-gray-300 rounded px-4 py-3 bg-[#F9F6F1] text-[#2A2A2A] outline-none"
          />
          <input
            type="text"
            name="phone"
          ...
          <textarea
            ...
            rows={5}
            className="w-full border border-gray-300 rounded px-4 py-3 bg-[#F9F6F1] text-[#2A2A2A] outline-none resize-none"
          />

          <button
            type="submit"
            className="w-full bg-[#38482A] text-[#F9F6F1] py-3 rounded hover:opacity-90 transition"
      ...
      <div className="container mx-auto grid md:grid-cols-3 gap-20 md:gap-6 text-center mt-40">
        ...
        <div className="bg-[#F9F6F1] p-6 rounded-xl relative">
          <div className="text-xl mb-2 absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <svg className='w-10' width="47" height="61" viewBox="0 0 47 61" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="bg-[#F9F6F1] p-6 rounded-xl relative">
          <div className="text-xl mb-2 absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <svg className='w-14' width="65" height="46" viewBox="0 0 65 46" fill="none" xmlns="http://www.w3.org/2000/svg">
